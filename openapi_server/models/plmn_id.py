...
class PlmnId(Model):
    ...
    def mnc(self, mnc):
        ...
        :type mnc: str
        """
        if mnc is not None and not re.search(r'[0-9]{3}|[0-9]{2}', mnc):  # noqa: E501
            raise ValueError("Invalid value for `mnc`, must be a follow pattern or equal to `/[0-9]{3}|[0-9]{2}/`")  # noqa: E501
